...
<meta http-equiv="content-type" content="text/html; charset=utf-8" />
<title>Ventas Biancolatte <?php echo $this->lang->line('login_login'); ?></title>
...
<body>
<h1>Biancolatte</h1>
<h3>Open Source Point Of Sale <?php echo $this->config->item('application_version'); ?></h3>
<?php
...
<?php echo validation_errors(); ?>
	...
	<div id="login_form">
		...
		<?php echo form_submit('loginButton','Acceder'); ?>
		</div>
	</div>
</div>
<?php echo form_close(); ?>
